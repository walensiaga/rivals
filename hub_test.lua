...
local CustomStyleTab = Window:CreateTab({
    Name = "Custom Styles",
    Icon = "style",
    ImageSource = "Material",
    ShowTitle = true
...
CustomStyleTab:CreateSection("Custom Style Selection")

CustomStyleTab:CreateButton({
    Name = "Get Gojo Satoru",
    Description = "Gojo Satoru from JJK!",
    Callback = function()
        loadstring(game:HttpGet('https://raw.githubusercontent.com/PresidentZuyi/H/refs/heads/main/B'))()
        Luna:Notification({
            Title = "Style Applied",
            Content = "Gojo Satoru Style has been applied!",
            Icon = "check_circle",
            ImageSource = "Material"
        })
    end
...
CustomStyleTab:CreateButton({
    ...
    Callback = function()
        ...
        Luna:Notification({
            Title = "Style Applied",
            Content = "Ego Jinpachi Style has been applied!",
            Icon = "check_circle",
            ImageSource = "Material"
        })
    end
